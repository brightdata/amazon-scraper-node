...
[![last verified](https://img.shields.io/badge/last%20verified-26%20Sep%202026-brightgreen)](https://github.com/brightdata/amazon-scraper-node/actions/workflows/live.yml) <!-- verified: rewritten by the daily run -->
...
Bugs in this repo:
[open an issue](https://github.com/brightdata/amazon-scraper-node/issues), and
